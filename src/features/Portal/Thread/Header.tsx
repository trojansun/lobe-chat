...
const Header = () => {
  const [newThreadMode] = useChatStore((s) => [chatPortalSelectors.newThreadMode(s)]);
      ...
      <Checkbox
        ...
        onChange={(e) => {
          useChatStore.setState({
            portalNewThreadMode: e.target.checked ? ThreadType.Continuation : ThreadType.Standalone,
          });
        }}
